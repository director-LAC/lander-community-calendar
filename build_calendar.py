...
# --- PART 5: GENERATE HTML (With Collapsible Mobile Header) ---
html_content = f"""
<!DOCTYPE html>
<html>
<head>
...
print(f"\n🎉 UI Upgraded! Mobile Collapsible Header Added.")
